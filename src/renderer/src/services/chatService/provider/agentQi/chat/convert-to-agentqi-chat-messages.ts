...
import { AgentQIChatPrompt } from './agentqi-chat-api-types'

export function convertToAgentQIChatMessages({
  prompt,
  responseFormat
}: {
  ...
  messages: AgentQIChatPrompt
  warnings: Array<SharedV3Warning>
} {
  const messages: AgentQIChatPrompt = []
