...
.tag-blue {
  ...
  border: 1px solid rgba(var(--color-info-rgb, 59, 130, 246), 0.15);
}

.tag-green {
  background-color: rgba(var(--color-success-rgb, 16, 185, 129), 0.15);
  color: var(--color-success);
  border: 1px solid rgba(var(--color-success-rgb, 16, 185, 129), 0.15);
}

.tag-orange {
  background-color: rgba(var(--color-warning-rgb, 245, 158, 11), 0.15);
  color: var(--color-warning);
  border: 1px solid rgba(var(--color-warning-rgb, 245, 158, 11), 0.15);
}
